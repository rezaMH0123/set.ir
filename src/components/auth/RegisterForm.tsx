...
export default function RegisterForm({ phoneNumber }: RegisterFormProps) {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      setLoading(true);
      let res: AxiosResponse<ApiResponse<LoginRespons>>;
      if (method === "post") {
        res = await httpService.post(url, payload);
      } else {
        res = await httpService.put(url, payload);
      }
